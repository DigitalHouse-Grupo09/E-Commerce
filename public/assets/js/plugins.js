  ...
  function init() {
    ...
    toast.create = function(options) {
      ...
      if (options.title || options.text) {
        ...
        content.className = 'cooltoast-content';
    ...
    toast.success = function(options) {
      options.title = options.title || '¡FELICITACIONES!';
      options.icon = '/assets/img/icon-success.png';
      options.type = 'success';
      return toast.create(options);
    }

    toast.info = function(options) {
      options.title = options.title || 'INFORMACIÓN';
      options.icon = '/assets/img/icon-info.png';
      options.type = 'info';
      return toast.create(options);
    }

    toast.warning = function(options) {
      options.title = options.title || 'ADVERTENCIA';
      options.icon = '/assets/img/icon-warning.png';
    ...
    toast.error = function(options) {
      ...
      options.icon = '/assets/img/icon-error.png';
      options.type = 'error';
      return toast.create(options);
    }
  }
